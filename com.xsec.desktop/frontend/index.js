function g(t,e){if(typeof t!="string"||!t)throw new Error(`${e}格式无效`);return t}function I(t){if(!t||typeof t!="object"||Array.isArray(t))throw new Error("项目文件条目格式无效");let e=t;if(typeof e.is_dir!="boolean"||typeof e.size!="number"||!Number.isFinite(e.size))throw new Error("项目文件元数据格式无效");return{name:g(e.name,"文件名"),path:g(e.path,"文件路径"),isDirectory:e.is_dir,size:e.size}}function y(t){if(!t||typeof t!="object"||Array.isArray(t)||!Array.isArray(t.files))throw new Error("项目文件列表结果无效");return t.files.map(I)}function w(t){if(!t||typeof t!="object"||Array.isArray(t)||typeof t.content!="string")throw new Error("文件读取结果无有效文本内容");return t.content}function E(t){let e=t.split(/\r?\n/,2001);return{lines:e.slice(0,2e3),truncated:e.length>2e3}}function j(t){return t<1024?`${t} B`:t<1048576?`${(t/1024).toFixed(t<1024*10?1:0)} KB`:`${(t/1048576).toFixed(1)} MB`}function b(t){let e=t?.workspace;return typeof e?.projectId=="string"?e.projectId:""}function v(t){return t?.workspace?.canAddComposerReference===!0}function A(t){let e=g(t,"评论").trim();if(!e||e.length>32768)throw new Error("评论内容无效");return e}var _="http://www.w3.org/2000/svg";var W={at:["circle:12:12:4","path:M16 8v1a4 4 0 0 1-8 0v-1a4 4 0 0 1 8 0Z","path:M16 8v4a2 2 0 0 0 4 0v-1a8 8 0 1 0-3 6"],chevronDown:["path:M6 9l6 6 6-6"],chevronRight:["path:M9 6l6 6-6 6"],file:["path:M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8Z","path:M14 2v6h6","path:M8 13h8","path:M8 17h8"],folder:["path:M3 7a2 2 0 0 1 2-2h5l2 2h7a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2Z","path:M3 9h18"],message:["path:M21 11.5a8.4 8.4 0 0 1-9 8.4 8.6 8.6 0 0 1-3.7-.9L3 21l1.8-4.6a8.4 8.4 0 0 1-.9-3.9 8.4 8.4 0 0 1 8.4-8.4 8.5 8.5 0 0 1 8.7 7.5Z"]};function C(t){return document.createElementNS(_,t)}function q(t,e){let[i,...r]=e.split(":"),o=C(i);i==="circle"&&["cx","cy","r"].forEach((s,a)=>o.setAttribute(s,r[a])),i==="path"&&o.setAttribute("d",r.join(":")),t.append(o)}function d(t){let e=C("svg");e.setAttribute("aria-hidden","true"),e.setAttribute("fill","none"),e.setAttribute("height","16"),e.setAttribute("stroke","currentColor"),e.setAttribute("stroke-linecap","round"),e.setAttribute("stroke-linejoin","round"),e.setAttribute("stroke-width","2"),e.setAttribute("viewBox","0 0 24 24"),e.setAttribute("width","16");for(let i of W[t]??[])q(e,i);return e}function n(t,e,i){let r=document.createElement(t);return e&&(r.className=e),i!==void 0&&(r.textContent=i),r}function p(t,e,i){let r=n("button",t);return r.type="button",r.setAttribute("aria-label",e),r.addEventListener("click",i),r}function f(t,e){let i=n("section","project-files-error",t);if(e){let r=p("project-files-retry","重试",e);r.textContent="重试",i.append(r)}return i}function L(t){return n("section","project-files-empty",t)}function m(t){let e=n("div","project-files-notice",t);return e.setAttribute("aria-live","polite"),e.setAttribute("role","status"),e}function h(t=8){let e=n("section","project-files-loading");for(let i=0;i<t;i+=1)e.append(n("span","project-files-loading-row"));return e}function D(t){queueMicrotask(()=>document.querySelector(t)?.focus())}function T(t,e){let i=p("project-file-header-action",`添加 ${e.name} 到会话`,()=>{t.addPath(e)}),r=t.state.addingPaths.has(e.path);return i.disabled=!t.composerWritable||r,i.title=t.composerWritable?"添加到会话":"当前会话不可编辑",r&&i.setAttribute("aria-busy","true"),i.append(d("at")),i}function N(t,e,i){let r=n("form","file-line-comment-editor"),o=n("div","file-line-comment-heading");o.append(d("message"),n("strong","","本地评论"),n("small","",`对第 ${e} 行发表评论`));let s=document.createElement("textarea");s.dataset.commentInput="",s.placeholder="输入给 Agent 的评论…",s.value=t.state.comment;let a;s.addEventListener("input",()=>{t.state.comment=s.value,a&&(a.disabled=!t.composerWritable||!s.value.trim())}),s.addEventListener("keydown",l=>{(l.metaKey||l.ctrlKey)&&l.key==="Enter"&&(l.preventDefault(),t.submitComment(e,i))});let c=n("footer","file-line-comment-footer"),u=p("","取消评论",()=>t.cancelComment());return u.textContent="取消",a=p("project-files-primary","添加到对话框",()=>{t.submitComment(e,i)}),a.disabled=!t.composerWritable||t.state.submittingComment||!s.value.trim(),t.state.submittingComment&&a.setAttribute("aria-busy","true"),a.textContent="添加到对话框",r.addEventListener("submit",l=>{l.preventDefault(),t.submitComment(e,i)}),c.append(u,a),r.append(o,s,c),D("[data-comment-input]"),r}function $(t){let e=n("div","project-file-code");e.setAttribute("aria-label",`${t.state.selected.name} 文件内容`),e.setAttribute("role","table");let i=E(t.state.content);return i.lines.forEach((r,o)=>{let s=o+1,a=n("div",`project-file-line${t.state.commentLine===s?" is-commenting":""}`);a.setAttribute("role","row");let c=p("file-line-comment-trigger",`评论第 ${s} 行`,()=>t.startComment(s));c.disabled=!t.composerWritable,c.append(d("message")),a.append(c,n("span","file-line-number",String(s)),n("code","",r||" ")),t.state.commentLine===s&&a.append(N(t,s,r)),e.append(a)}),{table:e,truncated:i.truncated}}function k(t){let e=t.state.selected,i=n("section","project-files-view has-preview"),r=n("section","project-file-preview"),o=n("header",""),s=p("project-file-header-action","返回项目文件树",()=>t.closeFile());if(s.append(d("folder")),o.append(s,n("strong","",e.name),n("small","",e.path),T(t,e)),r.append(o),t.state.actionError&&r.append(f(t.state.actionError)),t.state.actionNotice&&r.append(m(t.state.actionNotice)),t.state.previewError)r.append(f(t.state.previewError,()=>{t.openFile(e)}));else if(t.state.fileLoading)r.append(h());else{let a=$(t);r.append(a.table),a.truncated&&r.append(m(`文件行数较多，仅显示前 ${2e3.toLocaleString()} 行`))}return i.append(r),i}var R=`
:root {
